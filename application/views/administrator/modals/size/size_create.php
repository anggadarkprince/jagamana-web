<!-- MODALS -->
<div class="modal fade" id="modal-size-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" class="form-horizontal" action="<?=site_url()?>size/create" method="post" id="jm-form-size">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h3 class="modal-title" id="myModalLabel"><i class="fa fa-list-ul mrsm"></i>Size Create</h3>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="jm-size-name" class="col-sm-3 control-label">Size</label>
                        <div class="col-sm-9">
