<div class="title-section">
    <div class="title">
        ...
        <div class="pull-right mtxs">
            <a href="<?=site_url()?>applications/approved.html" class="btn-circle btn-o"><i class="fa fa-refresh"></i></a>
        </div>
    </div>
    ...
    <div class="tab-navigation">
        <ul class="list-inline">
            ...
            <li class="active"><a href="<?=site_url()?>applications/approved.html"><i class="fa fa-check"></i>APPROVED</a></li>
                ...
                if(isset($applications))
                {
                    foreach($applications as $application):
                        ...
                        <tr data-id="<?=$application["application_id"]?>">
                            ...
                            <td class="text-center">
                                <a href="<?=site_url()?>applications/discard/<?=$application["application_id"]?>/approved" class="btn btn-info btn-sm action"><i class="fa fa-reply mrxs"></i>DISCARD</a>
                            </td>
                        </tr>
