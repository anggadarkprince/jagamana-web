<div class="title-section">
    ...
    <div class="tab-navigation">
        <ul class="list-inline">
            <li><a href="<?=site_url()?>employee"><i class="fa fa-user"></i>EMPLOYEE</a></li>
            <li class="active"><a href="<?=site_url()?>employee/suspended"><i class="fa fa-remove"></i>SUSPENDED</a></li>
        </ul>
    </div>
</div>
                ...
                if(isset($employees))
                {
                    foreach($employees as $employee):
                        ...
                        <tr data-id="<?=$employee["emp_id"]?>" data-name="<?=$employee["emp_name"]?>">
                            ...
                            <td><a href="<?=site_url()?>account/detail/<?=permalink($employee["emp_name"], $employee["emp_id"])?>">View Details</a></td>
                            <td class="text-center">
                                <a href="<?=site_url()?>employee/activate/<?=permalink($employee["emp_name"], $employee["emp_id"])?>" class="btn btn-success btn-sm action"><i class="fa fa-check mrxs"></i>ACTIVATE</a>
