        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="main-content">
                    <form action="<?=site_url()?>thread/update/<?=$thread["permalink"]?>" method="post" class="form-horizontal" role="form" id="jm-form-thread">
                        <div class="form-section">
                            <div class="title">
                                <h3><i class="fa fa-edit"></i> Edit Thread Form</h3>
                            ...
                            ?>
                            <!-- end of alert -->
                            <input type="hidden" name="jm-thread-id" value="<?=$thread["thread_id"]?>">
                            <div class="form-group">
                                <label for="jm-thread-title" class="col-sm-2 control-label">Title</label>
                                <div class="col-sm-10 col-md-6">
                                    <input type="text" class="form-control" id="jm-thread-title" name="jm-thread-title" placeholder="Your thread title" required="true" maxlength="100" value="<?=set_value('jm-thread-title', $thread["title"]);?>">
                                        ...
                                        <?php
                                            if(isset($categories))
                                            {
                                                foreach($categories as $category):
                                                    ...
                                                    <option value="<?=$category["category_id"]?>" <?php echo set_select('jm-thread-category', $category["category_id"], $selected); ?>><?=$category["category"]?></option>
                                    ...
                                    <div class="mtxs">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio" for="jm-status-published">
                                                <input type="radio" value="PUBLISHED" id="jm-status-published" name="jm-thread-status" data-toggle="radio" class="custom-radio required" <?php echo set_radio('jm-thread-status', 'PUBLISHED', $published);?>>
                                                    <span class="icons">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio" for="jm-status-draft">
                                                <input type="radio" value="DRAFT" id="jm-status-draft" name="jm-thread-status" data-toggle="radio" class="custom-radio" <?php echo set_radio('jm-thread-status', 'DRAFT', $draft);?>>
                                                    <span class="icons">
                                                        <span class="icon-unchecked"></span>
                                                        <span class="icon-checked"></span>
                                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="jm-thread-content" name="jm-thread-content" class="form-control wysiwyg height" placeholder="Put your article, news and content" required><?=set_value('jm-thread-content', $thread["content"]);?></textarea>
