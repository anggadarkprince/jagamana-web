        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="main-content">
                    <form action="<?=site_url()?>job/update/<?=permalink($job["vacancy"],$job["job_id"])?>.html" method="post" class="form-horizontal" role="form" id="jm-form-job">
                        <div class="form-section">
                            <div class="title">
                                <h3><i class="fa fa-briefcase"></i> Edit Job</h3>
                                    ...
                                    <select class="form-control select select-primary mbl required" id="jm-job-field" name="jm-job-field" title="This field is required.">
                                        ...
                                        if(isset($fields))
                                        {
                                            ...
                                            ?>
                                                ...
                                                <option value="<?=$field["jfd_id"]?>" <?=set_select('jm-job-field', $field["jfd_id"], $selected); ?>><?=$field["jfd_field"]?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="jm-job-vacancy" name="jm-job-vacancy" placeholder="Your title job vacancy" required maxlength="45" value="<?=set_value('jm-job-vacancy', $job["job_vacancy"]);?>">
                                    ...
                                    <select class="form-control select select-primary mbl required" id="jm-job-type" name="jm-job-type" title="This field is required.">
                                        ...
                                        if(isset($types))
                                        {
                                            foreach($types as $type):
                                                ...
                                                <option value="<?=$type["jty_id"]?>" <?=set_select('jm-job-type', $type["jty_id"], $selected); ?>><?=$type["jty_type"]?></option>
                                    ...
                                    <select class="form-control select select-primary mbl required" id="jm-job-level" name="jm-job-level" title="This field is required.">
                                        ...
                                        if(isset($levels))
                                        {
                                            foreach($levels as $level):
                                                ...
                                                <option value="<?=$level["jlv_id"]?>" <?=set_select('jm-job-level', $level["jlv_id"], $selected); ?>><?=$level["jlv_level"]?></option>
                                            ...
                                            <select class="form-control select select-primary select-block mbl required" id="jm-job-location-country" name="jm-job-location-country" title="This field is required.">
                                                ...
                                                if(isset($countries))
                                                {
                                                    foreach($countries as $country):
                                                        $selected = "";
                                                        if($job["country_id"] == $country["ctr_id"])
                                                        {
                                                            $selected = TRUE;
                                                        }
                                                        else{
                                                        ...
                                                        <option value="<?=$country["ctr_id"]?>" <?=set_select('jm-job-location-country', $country["ctr_id"], $selected); ?>><?=$country["ctr_country"]?></option>
                                            ...
                                            <select class="form-control select select-primary select-block mbl required" id="jm-job-location-province" name="jm-job-location-province" title="This field is required.">
                                                ...
                                                if(isset($states))
                                                {
                                                    foreach($states as $state):
                                                        ...
                                                        <option value="<?=$state["stt_id"]?>" <?=set_select('jm-job-location-province', $state["stt_id"], $selected); ?>><?=$state["stt_state"]?></option>
                                            ...
                                            <select class="form-control select select-primary select-block mbl required" id="jm-job-location-city" name="jm-job-location-city" title="This field is required.">
                                                ...
                                                if(isset($cities))
                                                {
                                                    foreach($cities as $city):
                                                        ...
                                                        <option value="<?=$city["cty_id"]?>" <?=set_select('jm-job-location-city', $city["cty_id"], $selected); ?>><?=$city["cty_city"]?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="5" id="jm-job-description" name="jm-job-description" class="form-control" placeholder="Describe the job and necessary information" maxlength="4000" required><?=set_value('jm-job-description', $job["job_description"]);?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="jm-job-responsibility" name="jm-job-responsibility" class="form-control wysiwyg" placeholder="Describe by list what candidate to do at work" maxlength="4000" required><?=set_value('jm-job-responsibility', $job["job_responsibility"]);?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="jm-job-qualification" name="jm-job-qualification" class="form-control wysiwyg" placeholder="Specify the job requirement like education, certification, ect" maxlength="4000" required><?=set_value('jm-job-qualification', $job["job_qualification"]);?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control datepicker" id="jm-job-open" name="jm-job-open" placeholder="Date this vacancy open" value="<?=set_value('jm-job-open', ($job["job_open"] != null)?date_format(date_create($job["job_open"]),"d F Y"):"");?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control datepicker" id="jm-job-close" name="jm-job-close" placeholder="Date this vacancy close" value="<?=set_value('jm-job-close', ($job["job_open"] != null)?date_format(date_create($job["job_close"]),"d F Y"):"");?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="mbsm">
                                        ...
                                        ?>
                                        <input type="checkbox" data-toggle="switch" data-on-color="info" id="jm-job-ready" name="jm-job-ready" <?=set_checkbox('jm-job-ready', "on", $ready); ?>/>
                                    </div>
