        ...
        <div style="margin: auto; max-width: 650px">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h1 class="pull-left mllg mrmd mtsm"><i class="fa fa-envelope-o"></i></h1>
                    <h3 class="mbn mtsm">Register Success,</h3>
                    <p class="mbn">One more step, check the your email to activate your account</p>
