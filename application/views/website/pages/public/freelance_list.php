...
<script>
    $(document).ready(function(){
        ...
        var type = "freelance";
        var base_url = "<?=site_url()?>"+"job/archive/<?=$archive["year"]?>/<?=$archive["month"]?>/<?=$archive["date"]?>.html";
        var filter_url = "";
        var page = 0;
        ...
        function update_data(link, reset){
            ...
            var data_link = "<?=site_url()?>"+"job/filter/"+type+"/<?=$archive["year"]?>/<?=$archive["month"]?>/<?=$archive["date"]?>";

            if(reset){
                page = 0;
                data_link = "<?=site_url()?>"+"job/filter/"+type+"/<?=$archive["year"]?>/<?=$archive["month"]?>/<?=$archive["date"]?>";
            }
            else{
