...
class Pdf extends FPDF
{
    ...
    function Footer()
    {
        ...
        $this->SetY(-20);
        $this->Cell(80, 5, 'Jagamana Medic Job Marketplace', 0, 0, 'L');
        $this->SetFont('Arial', '', 8);
        $this->SetX(-47);

        // Page number
        $this->Cell(30, 5, 'Page ' . $this->PageNo() . ' of {nb}', 0, 1, 'R');
        $this->Cell(125, 4, 'Copyright '.date("Y").' Jagamana, Powered by Sketch Project Studio', 0, 1, 'L');
    }
